const SkeletonLoader = ({ type = "card", count = 1 }) => {
  const CardSkeleton = () => (
    <div className="bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-800 animate-pulse">
      ...
      <div className="relative h-64 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800">
        <div className="absolute top-4 left-4 w-20 h-6 bg-white/50 dark:bg-gray-800/50 rounded-full"></div>
        <div className="absolute top-4 right-4 w-16 h-6 bg-white/50 dark:bg-gray-800/50 rounded-full"></div>
      </div>
  ...
  const BlogCardSkeleton = () => (
    <div className="group relative bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-800 animate-pulse">
      {/* Image Container */}
      <div className="relative h-64 overflow-hidden bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800">
        ...
        <div className="absolute top-4 left-4 z-10">
          <div className="w-20 h-6 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-full"></div>
        </div>
  ...
  const NewsCardSkeleton = () => (
    <div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md border border-gray-200 dark:border-gray-700 animate-pulse">
      <div className="flex flex-col lg:flex-row">
        {/* Image Section */}
        <div className="lg:w-2/5 h-64 lg:h-auto relative overflow-hidden bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800">
          {/* Breaking News Badge */}
        ...
        <div className="lg:w-3/5 flex flex-col justify-between p-6 lg:p-8">
          <div>
            ...
            <div className="mb-3 space-y-2">
              ...
              <div className="h-7 bg-gray-200 dark:bg-gray-700 rounded w-5/6"></div>
            </div>
  ...
  const CircleSkeleton = ({ size = "w-12 h-12" }) => (
    <div className={`${size} rounded-full bg-gray-200 dark:bg-gray-700`}></div>
  );
