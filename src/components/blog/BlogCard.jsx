  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", justifyContent: "flex-end", marginRight: "1rem" }}>
        <Button onClick={() => navigate(`/blog/detail/${_id}`, { state: { _id, content, image, title, userId, createdAt, likes, countOfVisitors } })} variant="contained" sx={{ marginBottom: "1rem", backgroundColor: "primary.light" }} >
          Read More
        </Button>
      </Box>
