    ...
    return (
        <Box backgroundColor="neutral.dark" sx={{
            ...
            <Typography sx={infoMessage}>
                <strong><i>On this blog site</i></strong>, you can freely share your thoughts and get ideas by reading blogs on topics you are curious about. This blog site is created for everyone to express their ideas.
                <br />
            </Typography>
            <Typography sx={{
                ...infoMessage,
                ...
                <strong><i>2-)</i></strong>  Personal rights should be respected.<br />
