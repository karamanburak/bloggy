...
const Profile = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 transition-colors duration-300 pt-20 flex flex-col">
        {/* Cover Image Skeleton */}
        <div className="relative h-64 md:h-80 w-full overflow-hidden bg-gradient-to-br from-primary-200 via-accent-200 to-primary-200 animate-pulse"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 pb-12 flex-1 w-full">
          {/* Profile Card Skeleton */}
          <div className="relative overflow-visible rounded-3xl bg-white/90 backdrop-blur-xl border border-gray-200/50 shadow-2xl p-6 lg:p-10 mb-8 pt-28 md:pt-8">
            <div className="flex flex-col md:flex-row items-start md:items-end gap-8">
              {/* Avatar Skeleton */}
              <div className="relative -mt-24 md:-mt-28 mx-auto md:mx-0">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gray-200 animate-pulse border-4 border-white"></div>
              </div>
          ...
          <div className="relative mb-8">
            <div className="flex space-x-2 bg-gray-100/80 backdrop-blur-sm rounded-2xl p-2 border border-gray-200/50">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end gap-8">
            ...
            <div className="relative -mt-24 md:-mt-28 mx-auto md:mx-0">
              <div className="relative group">
                ...
                <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white overflow-hidden bg-gradient-to-br from-primary-500 to-accent-500 shadow-2xl transition-transform duration-300 group-hover:scale-105">
                  {image ? (
                    <img
                      src={image}
            ...
            <div className="flex-1 w-full text-center md:text-left">
              <div className="flex flex-col gap-6">
                <div className="flex-1">
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent mb-2">
                    {firstName} {lastName}
                  </h1>
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm">
                  {city && (
                    <div className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-gray-100/80 backdrop-blur-sm border border-gray-200/50 hover:bg-gray-200/80 transition-colors">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {statsCards.map((card) => {
            ...
            return (
              <div
                key={card.id}
                className={`group relative overflow-hidden rounded-2xl bg-gradient-to-br ${card.gradientFrom} ${card.gradientTo} border ${card.borderColor} p-6 hover:shadow-xl transition-all duration-300`}
              >
